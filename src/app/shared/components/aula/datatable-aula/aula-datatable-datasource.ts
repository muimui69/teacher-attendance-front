...
export class AulaDatableDataSource extends DataSource<DatumA> {
  data: DatumA[] = [];
   ...
   */
  private getPagedData(data: DatumA[]): DatumA[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: DatumA[]): DatumA[] {
